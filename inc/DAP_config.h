/**************************************************************************//**
 * @file     DAP_config.h
 * @brief    DAPLINK DAP config for LPC11U35
 * @version  V0.1
 * @date     08. May 2015
 *
 * @note
...
//**************************************************************************************************
/**
\defgroup DAP_Config_Debug_gr DAPLINK Debug Unit Information
\ingroup DAP_ConfigIO_gr
@{
Provides definitions about:
 - Definition of Cortex-M processor parameters used in DAPLINK Debug Unit.
...
#define TARGET_DEVICE_NAME      "DAPLINK-LPC11U35 DAPLINK"              ///< String indicating the Target Device
#endif
...
//**************************************************************************************************
/**
\defgroup DAP_Config_PortIO_gr DAPLINK Hardware I/O Pin Access
\ingroup DAP_ConfigIO_gr
@{

Standard I/O Pins of the DAPLINK Hardware Debug Port support standard JTAG mode
and Serial Wire Debug (SWD) mode. In SWD mode only 2 pins are required to implement the debug
interface of a device. The following I/O Pins are provided:

JTAG I/O Pin                 | SWD I/O Pin          | DAPLINK Hardware pin mode
---------------------------- | -------------------- | ---------------------------------------------
...
//**************************************************************************************************
/**
\defgroup DAP_Config_LEDs_gr DAPLINK Hardware Status LEDs
\ingroup DAP_ConfigIO_gr
@{

DAPLINK Hardware may provide LEDs that indicate the status of the DAPLINK Debug Unit.
...
\param bit status of the Connect LED.
           - 1: Connect LED ON: debugger is connected to DAPLINK Debug Unit.
           - 0: Connect LED OFF: debugger is not connected to DAPLINK Debug Unit.
*/
...
//**************************************************************************************************
/**
\defgroup DAP_Config_Initialization_gr DAPLINK Initialization
\ingroup DAP_ConfigIO_gr
@{

DAPLINK Hardware I/O and LED Pins are initialized with the function \ref DAP_SETUP.
*/

/** Setup of the Debug Unit I/O pins and LEDs (called when Debug Unit is initialized).
This function performs the initialization of the DAPLINK Hardware I/O Pins and the
